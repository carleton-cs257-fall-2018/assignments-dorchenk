...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("gravity.fxml"));
...
//        root.setOnKeyPressed(controller);
        ...
        // this application, go to gravity.fxml and delete or comment out the <Button> object.
        ...
        //
        // But what happens if we delete the Button from gravity.fxml? It turns out that none of the remaining
        // nodes in gravity.fxml is "focus traversable" by default. So we end up with an event dispatch chain in
        ...
        //
        // Want to play around with these ideas? Try commenting the Button object in gravity.fxml in and out
